...
<div class="accordion-item group-<?php echo $group->id; ?>">
    <h2 class="accordion-header" id="group-<?php echo $group->id; ?>">
        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo $group->id; ?>" aria-expanded="false" aria-controls="collapse<?php echo $group->id; ?>">
            <?php echo $group->id > 0 ? $group->group_name : "New group"; ?>
        </button>
    </h2>
    <div id="collapse<?php echo $group->id; ?>" class="accordion-collapse collapse" aria-labelledby="group-<?php echo $group->id; ?>" data-bs-parent="#llGroupsAccordion">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <div class="form-check mt-2 datepickers-container">
                            ...
                            <div class="form-group mb-1">
                                <label for="discount_<?php echo $group->id; ?>">Discount</label>

                                <div class="input-group mb-3">
                                    <input type="number" step=".01" class="form-control" id="discount_<?php echo $group->id; ?>" name="discount" value="<?php echo $group->discount; ?>">
                                    <div class="input-group-append">
                                        <span class="input-group-text" id="append-addon2">%</span>
                                    </div>
                                </div>
                        ...
                        <div class="form-check mt-2 bestseller-container pl-5">
